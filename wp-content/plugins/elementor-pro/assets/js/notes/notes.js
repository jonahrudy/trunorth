(()=>{var __webpack_modules__=({"../assets/js/app/hooks/use-active-thread.js"
...
return window.top.$e.run('notes/set-active',{type,data});},[]);const clearActive=(0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((id=null)=>{return window.top.$e.run('notes/clear-active',{id});},[]);const isThreadActive=(0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(noteId=>{return THREAD===activeThread?.type&&activeThread?.data.noteId===noteId;},[activeThread]);return{activeThread,setActive,clearActive,isThreadActive};}},"../assets/js/app/models/base-model.js"

/*!*********************************************!*\
  !*** ../assets/js/app/models/base-model.js ***!
  \*********************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{"default":()=>(BaseModel)});class BaseModel{init(data={}){Object.entries(data).forEach(([key,value])=>{this[key]=value;});return this;}}},"../assets/js/app/models/document.js"
...
static createDeleted(name=''){const{avatar_defaults:avatarUrls}=window.top.$e.components.get('notes').config.urls;return new User().init({name:[name,__('(deleted user)','elementor-pro')].join(' '),avatarUrls});}}},"../assets/js/commands/clear-active.js"

/*!*********************************************!*\
  !*** ../assets/js/commands/clear-active.js ***!
  \*********************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{ClearActive:()=>(ClearActive),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});class ClearActive extends $e.modules.CommandBase{apply({id=null}={}){const{store}=window.top.$e,{actions}=store.get('notes');store.dispatch(actions.clearActive(id));}}
const __WEBPACK_DEFAULT_EXPORT__=(ClearActive);},"../assets/js/commands/close.js"

/*!**************************************!*\
  !*** ../assets/js/commands/close.js ***!
  \**************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Close:()=>(Close),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});class Close extends $e.modules.CommandBase{apply(){this.component.close();}}
const __WEBPACK_DEFAULT_EXPORT__=(Close);},"../assets/js/commands/copy-link.js"

/*!******************************************!*\
  !*** ../assets/js/commands/copy-link.js ***!
  \******************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{CopyLink:()=>(CopyLink),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});var _app_models_note__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ../app/models/note */"../assets/js/app/models/note.js");var _services_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ../services/copy-to-clipboard */"../assets/js/services/copy-to-clipboard/index.js");class CopyLink extends $e.modules.CommandBase{validateArgs(args={}){this.requireArgumentType('id','number',args);}
apply(args){return(0,_services_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(_app_models_note__WEBPACK_IMPORTED_MODULE_0__["default"].getURL(args.id));}}
const __WEBPACK_DEFAULT_EXPORT__=(CopyLink);},"../assets/js/commands/filter.js"

/*!***************************************!*\
  !*** ../assets/js/commands/filter.js ***!
  \***************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Filter:()=>(Filter),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});class Filter extends $e.modules.CommandBase{validateArgs(args={}){this.requireArgument('filters',args);}
apply(args){const{store}=window.top.$e,{actions}=store.get('notes'),action=args.overwrite?actions.setFilters:actions.modifyFilters;store.dispatch(action(args.filters));}}
const __WEBPACK_DEFAULT_EXPORT__=(Filter);},"../assets/js/commands/index.js"

/*!**************************************!*\
  !*** ../assets/js/commands/index.js ***!
  \**************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{ClearActive:()=>(_clear_active__WEBPACK_IMPORTED_MODULE_0__.ClearActive),Close:()=>(_close__WEBPACK_IMPORTED_MODULE_1__.Close),CopyLink:()=>(_copy_link__WEBPACK_IMPORTED_MODULE_2__.CopyLink),Filter:()=>(_filter__WEBPACK_IMPORTED_MODULE_3__.Filter),Open:()=>(_open__WEBPACK_IMPORTED_MODULE_4__.Open),SetActive:()=>(_set_active__WEBPACK_IMPORTED_MODULE_5__.SetActive),Toggle:()=>(_toggle__WEBPACK_IMPORTED_MODULE_6__.Toggle)});var _clear_active__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./clear-active */"../assets/js/commands/clear-active.js");var _close__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./close */"../assets/js/commands/close.js");var _copy_link__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! ./copy-link */"../assets/js/commands/copy-link.js");var _filter__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(/*! ./filter */"../assets/js/commands/filter.js");var _open__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(/*! ./open */"../assets/js/commands/open.js");var _set_active__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(/*! ./set-active */"../assets/js/commands/set-active.js");var _toggle__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(/*! ./toggle */"../assets/js/commands/toggle.js");},"../assets/js/commands/open.js"

/*!*************************************!*\
  !*** ../assets/js/commands/open.js ***!
  \*************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Open:()=>(Open),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});var _app_hooks_use_active_thread__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ../app/hooks/use-active-thread */"../assets/js/app/hooks/use-active-thread.js");class Open extends $e.modules.CommandBase{static getInfo(){return{isSafe:true,isSafeWithArgs:true};}
apply(args){window.top.$e.route(this.component.getNamespace());const noteId=parseInt(args.id||'0');if(noteId>0){window.top.$e.run('notes/set-active',{type:_app_hooks_use_active_thread__WEBPACK_IMPORTED_MODULE_0__.THREAD,data:{noteId}});}}}
const __WEBPACK_DEFAULT_EXPORT__=(Open);},"../assets/js/commands/set-active.js"

/*!*******************************************!*\
  !*** ../assets/js/commands/set-active.js ***!
  \*******************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{SetActive:()=>(SetActive),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});class SetActive extends $e.modules.CommandBase{validateArgs(args={}){this.requireArgument('type',args);this.requireArgument('data',args);}
apply({type,data}){const{store}=window.top.$e;if(store.getState().notes.formsInWritingMode.length>0){return;}
const{actions}=store.get('notes');store.dispatch(actions.setActive({type,data}));}}
const __WEBPACK_DEFAULT_EXPORT__=(SetActive);},"../assets/js/commands/toggle.js"

/*!***************************************!*\
  !*** ../assets/js/commands/toggle.js ***!
  \***************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Toggle:()=>(Toggle),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});class Toggle extends $e.modules.CommandBase{apply(){if(this.component.isOpen){window.top.$e.run('notes/close');}else{window.top.$e.run('notes/open');}}}
const __WEBPACK_DEFAULT_EXPORT__=(Toggle);},"../assets/js/data-commands/index.js"

/*!*******************************************!*\
  !*** ../assets/js/data-commands/index.js ***!
  \*******************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Index:()=>(Index),ReadStatus:()=>(_read_status__WEBPACK_IMPORTED_MODULE_0__.ReadStatus),Summary:()=>(_summary__WEBPACK_IMPORTED_MODULE_1__.Summary),Users:()=>(_users__WEBPACK_IMPORTED_MODULE_2__.Users)});var _read_status__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./read-status */"../assets/js/data-commands/read-status.js");var _summary__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./summary */"../assets/js/data-commands/summary.js");var _users__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! ./users */"../assets/js/data-commands/users.js");class Index extends $e.modules.CommandData{static getEndpointFormat(){return'notes/{id}';}}},"../assets/js/data-commands/read-status.js"

/*!*************************************************!*\
  !*** ../assets/js/data-commands/read-status.js ***!
  \*************************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{ReadStatus:()=>(ReadStatus)});class ReadStatus extends $e.modules.CommandData{static getEndpointFormat(){return'notes/read-status';}}},"../assets/js/data-commands/summary.js"

/*!*********************************************!*\
  !*** ../assets/js/data-commands/summary.js ***!
  \*********************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Summary:()=>(Summary)});class Summary extends $e.modules.CommandData{static getEndpointFormat(){return'notes/summary';}}},"../assets/js/data-commands/users.js"

/*!*******************************************!*\
  !*** ../assets/js/data-commands/users.js ***!
  \*******************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{Users:()=>(Users)});class Users extends $e.modules.CommandData{static getEndpointFormat(){return'notes/users';}}},"../assets/js/e-component.js"

/*!***********************************!*\
  !*** ../assets/js/e-component.js ***!
  \***********************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{"default":()=>(EComponent)});var _commands___WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./commands/ */"../assets/js/commands/index.js");var _data_commands___WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./data-commands/ */"../assets/js/data-commands/index.js");var _hooks___WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! ./hooks/ */"../assets/js/hooks/index.js");var _notes_context_menu__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(/*! ./notes-context-menu */"../assets/js/notes-context-menu.js");class EComponent extends $e.modules.ComponentBase{static NOTES_MODE_OPEN='open';static NOTES_MODE_CLOSE='close';config={};constructor(args){super(args);window.addEventListener('message',event=>{if(event.data.name!=='elementor-pro/notes/config'){return;}
this.config={...this.config,...event.data.payload};if(!this.isInEditor()){window.top.$e.extras.hashCommands.runOnce();}
this.contextMenuNotesGroup();});window.addEventListener('DOMContentLoaded',()=>{const adminBarButton=document.getElementById('wp-admin-bar-elementor_notes');if(!adminBarButton){return;}
adminBarButton.addEventListener('click',e=>{e.preventDefault();window.top.$e.run('notes/toggle');});});}
getNamespace(){return'notes';}
defaultRoutes(){return{'':()=>{}};}
defaultCommands(){const trackingCommands=['create','reply','edit','delete','resolve','re-open','cancel-create','cancel-reply','cancel-edit','choose-mention','open-note-actions','close-note-actions','open-panel-filters','close-panel-filters','refresh-panel'].reduce((allCommands,command)=>({...allCommands,[command]:()=>{}}),{});return{...this.importCommands(_commands___WEBPACK_IMPORTED_MODULE_0__),...trackingCommands};}
defaultData(){return this.importCommands(_data_commands___WEBPACK_IMPORTED_MODULE_1__);}
defaultHooks(){return this.importHooks(_hooks___WEBPACK_IMPORTED_MODULE_2__);}
defaultShortcuts(){return{toggle:{keys:'shift+c',exclude:['input','textarea']}};}
defaultStates(){return{'':{initialState:{active:null,formsInWritingMode:[],filters:{is_resolved:null,only_unread:null,only_relevant:null}},reducers:{setFilters:(state,{payload})=>{return{...state,filters:payload};},modifyFilters:(state,{payload})=>{return{...state,filters:{...state.filters,...payload}};},setActive:(state,{payload})=>{return{...state,active:{type:payload.type,data:payload.data},formsInWritingMode:[]};},clearActive:(state,{payload:id}={})=>{const shouldClear=!id||state.active?.data?.noteId===id;if(!shouldClear){return state;}
return{...state,active:null,formsInWritingMode:[]};},addFormToWritingMode(state,{payload}){return{...state,formsInWritingMode:[...state.formsInWritingMode,payload]};},removeFormFromWritingMode(state,{payload}){return{...state,formsInWritingMode:state.formsInWritingMode.filter(id=>id!==payload)};}}}};}
open(){if(this.isOpen){return false;}
if(this.isInEditor()){this.updateEditorState(this.constructor.NOTES_MODE_OPEN);}
this.getPreviewFrame().postMessage({name:'elementor-pro/notes/open'},'*');return true;}
close(){if(!super.close()){return false;}
if(this.isInEditor()){this.updateEditorState(this.constructor.NOTES_MODE_CLOSE);}
this.getPreviewFrame().postMessage({name:'elementor-pro/notes/close'},'*');return true;}
isInEditor(){return!!window.elementor;}
updateEditorState(mode){switch(mode){case this.constructor.NOTES_MODE_OPEN:elementor.getPanelView().modeSwitcher.currentView.setMode('preview');elementor.channels.dataEditMode.once('switch',()=>{if(!this.isOpen){return;}
window.top.$e.run('notes/close');});break;case this.constructor.NOTES_MODE_CLOSE:elementor.getPanelView().modeSwitcher.currentView.setMode('editor');break;default:throw new Error(`mode '${mode}' is not supported.`);}}
getPreviewFrame(){return this.isInEditor()?elementor.$preview[0].contentWindow:window;}
contextMenuNotesGroup(){if(!this.isInEditor()){return;}
new _notes_context_menu__WEBPACK_IMPORTED_MODULE_3__["default"]();}}},"../assets/js/hooks/index.js"

/*!***********************************!*\
  !*** ../assets/js/hooks/index.js ***!
  \***********************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{NotesAddPanelMenuItem:()=>(_ui_panel_state_ready_notes_add_panel_menu_item__WEBPACK_IMPORTED_MODULE_0__.NotesAddPanelMenuItem)});var _ui_panel_state_ready_notes_add_panel_menu_item__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./ui/panel/state-ready/notes-add-panel-menu-item */"../assets/js/hooks/ui/panel/state-ready/notes-add-panel-menu-item.js");},"../assets/js/hooks/ui/panel/state-ready/notes-add-panel-menu-item.js"

/*!****************************************************************************!*\
  !*** ../assets/js/hooks/ui/panel/state-ready/notes-add-panel-menu-item.js ***!
  \****************************************************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{NotesAddPanelMenuItem:()=>(NotesAddPanelMenuItem),"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});var __=__webpack_require__(/*! @wordpress/i18n */"@wordpress/i18n")["__"];class NotesAddPanelMenuItem extends $e.modules.hookUI.After{getCommand(){return'panel/state-ready';}
getId(){return'notes-add-panel-menu-item';}
apply(){elementor.modules.layouts.panel.pages.menu.Menu.addItem({name:'notes',icon:'eicon-commenting-o',title:__('Notes','elementor-pro'),callback:()=>window.top.$e.run('notes/open')},'navigate_from_page','finder');}}
const __WEBPACK_DEFAULT_EXPORT__=(NotesAddPanelMenuItem);},"../assets/js/notes-context-menu.js"

/*!******************************************!*\
  !*** ../assets/js/notes-context-menu.js ***!
  \******************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{"default":()=>(__WEBPACK_DEFAULT_EXPORT__),notesContextMenu:()=>(notesContextMenu)});var __=__webpack_require__(/*! @wordpress/i18n */"@wordpress/i18n")["__"];class notesContextMenu{constructor(){const elTypes=['widget','section','column','container'];elTypes.forEach(type=>{elementor.hooks.addFilter(`elements/${type}/contextMenuGroups`,this.notesContextMenuAddGroup);});}
...
const __WEBPACK_DEFAULT_EXPORT__=(notesContextMenu);},"../assets/js/services/copy-to-clipboard/index.js"

/*!********************************************************!*\
  !*** ../assets/js/services/copy-to-clipboard/index.js ***!
  \********************************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{canCopyToClipboard:()=>(canCopyToClipboard),copyToClipboard:()=>(copyToClipboard)});function canCopyToClipboard(){return!!navigator?.clipboard;}
...
navigator.clipboard.writeText(value);}},"../../../node_modules/hoist-non-react-statics/dist/hoist-non-react-statics.cjs.js"
...
/*!************************************************************************************!*\
  ...
  \************************************************************************************/
(module,__unused_webpack_exports,__webpack_require__){"use strict";if(false){}else{module.exports=__webpack_require__(/*! ./cjs/react-is.development.js */"../../../node_modules/hoist-non-react-statics/node_modules/react-is/cjs/react-is.development.js");}},"../../../node_modules/object-assign/index.js"
...
/*!***********************************************************************!*\
  ...
  \***********************************************************************/
(module,__unused_webpack_exports,__webpack_require__){"use strict";if(false){}else{module.exports=__webpack_require__(/*! ./cjs/react-is.development.js */"../../../node_modules/prop-types/node_modules/react-is/cjs/react-is.development.js");}},"../../../node_modules/react-redux/es/components/Context.js"
...
/*!*******************************************************************!*\
  ...
  \*******************************************************************/
(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{"default":()=>(__WEBPACK_DEFAULT_EXPORT__)});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! react */"react");var react__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);var prop_types__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! prop-types */"../../../node_modules/prop-types/index.js");var prop_types__WEBPACK_IMPORTED_MODULE_1___default=__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);var _Context__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! ./Context */"../../../node_modules/react-redux/es/components/Context.js");var _utils_Subscription__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(/*! ../utils/Subscription */"../../../node_modules/react-redux/es/utils/Subscription.js");var _utils_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(/*! ../utils/useIsomorphicLayoutEffect */"../../../node_modules/react-redux/es/utils/useIsomorphicLayoutEffect.js");function Provider(_ref){var store=_ref.store,context=_ref.context,children=_ref.children;var contextValue=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function(){var subscription=(0,_utils_Subscription__WEBPACK_IMPORTED_MODULE_3__.createSubscription)(store);return{store:store,subscription:subscription};},[store]);var previousState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function(){return store.getState();},[store]);(0,_utils_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_4__.useIsomorphicLayoutEffect)(function(){var subscription=contextValue.subscription;subscription.onStateChange=subscription.notifyNestedSubs;subscription.trySubscribe();if(previousState!==store.getState()){subscription.notifyNestedSubs();}
...
if(true){Provider.propTypes={store:prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({subscribe:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func).isRequired,dispatch:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func).isRequired,getState:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func).isRequired}),context:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().object),children:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().any)};}
...
/*!************************************************************************!*\
  ...
  \************************************************************************/
(module,__unused_webpack_exports,__webpack_require__){"use strict";if(false){}else{module.exports=__webpack_require__(/*! ./cjs/react-is.development.js */"../../../node_modules/react-redux/node_modules/react-is/cjs/react-is.development.js");}},"react"
...
/*!**************************!*\
  !*** external "wp.i18n" ***!
  \**************************/
(module){"use strict";module.exports=wp.i18n;},"../../../node_modules/@babel/runtime/helpers/esm/extends.js"
...
return n;},_extends.apply(null,arguments);}},"../../../node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js"

/*!****************************************************************************************!*\
  !*** ../../../node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js ***!
  \****************************************************************************************/
(__unused_webpack___webpack_module__,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{"default":()=>(_objectWithoutPropertiesLoose)});function _objectWithoutPropertiesLoose(r,e){if(null==r)return{};var t={};for(var n in r)if({}.hasOwnProperty.call(r,n)){if(-1!==e.indexOf(n))continue;t[n]=r[n];}
return t;}}});var __webpack_module_cache__={};function __webpack_require__(moduleId){var cachedModule=__webpack_module_cache__[moduleId];if(cachedModule!==undefined){return cachedModule.exports;}
...
/*!*****************************!*\
  !*** ../assets/js/notes.js ***!
  \*****************************/
__webpack_require__.r(__webpack_exports__);var _e_component__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./e-component */"../assets/js/e-component.js");window.top.$e.components.register(new _e_component__WEBPACK_IMPORTED_MODULE_0__["default"]());})();})();