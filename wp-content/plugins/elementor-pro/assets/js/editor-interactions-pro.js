...
/*!**********************************************************************!*\
  ...
  \**********************************************************************/
(__unused_webpack_module,__unused_webpack_exports,__webpack_require__){__webpack_require__(/*! ../modules/es.iterator.constructor */"../node_modules/core-js/modules/es.iterator.constructor.js");},"../node_modules/core-js/modules/esnext.iterator.filter.js"

/*!*****************************************************************!*\
  !*** ../node_modules/core-js/modules/esnext.iterator.filter.js ***!
  \*****************************************************************/
(__unused_webpack_module,__unused_webpack_exports,__webpack_require__){__webpack_require__(/*! ../modules/es.iterator.filter */"../node_modules/core-js/modules/es.iterator.filter.js");},"../node_modules/core-js/modules/esnext.iterator.find.js"

/*!***************************************************************!*\
  !*** ../node_modules/core-js/modules/esnext.iterator.find.js ***!
  \***************************************************************/
(__unused_webpack_module,__unused_webpack_exports,__webpack_require__){__webpack_require__(/*! ../modules/es.iterator.find */"../node_modules/core-js/modules/es.iterator.find.js");},"../node_modules/core-js/modules/esnext.iterator.for-each.js"
...
/*!********************************************************************!*\
  ...
  \********************************************************************/
__webpack_require__(/*! core-js/modules/esnext.iterator.constructor.js */"../node_modules/core-js/modules/esnext.iterator.constructor.js");__webpack_require__(/*! core-js/modules/esnext.iterator.filter.js */"../node_modules/core-js/modules/esnext.iterator.filter.js");__webpack_require__(/*! core-js/modules/esnext.iterator.find.js */"../node_modules/core-js/modules/esnext.iterator.find.js");__webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */"../node_modules/core-js/modules/esnext.iterator.for-each.js");__webpack_require__(/*! core-js/modules/esnext.iterator.map.js */"../node_modules/core-js/modules/esnext.iterator.map.js");var _interactionsUtils=__webpack_require__(/*! ./interactions-utils.js */"../modules/interactions/assets/js/interactions-utils.js");const playingInteractionsToStop={};const MAX_REPEAT_COUNT_EDITOR=3;function applyAnimation(element,animConfig,animateFunc){const{id}=element;if(playingInteractionsToStop[id]){playingInteractionsToStop[id].cancel();delete playingInteractionsToStop[id];}
const keyframes=(0,_interactionsUtils.animationKeyframes)(animConfig);const isScrollOn='scrollOn'===animConfig.trigger;const repeatOptions=isScrollOn?{}:(0,_interactionsUtils.getAnimationRepeatOptions)(animConfig.animation);if(repeatOptions.repeat===Infinity){repeatOptions.repeat=MAX_REPEAT_COUNT_EDITOR;}
const options={duration:animConfig.animation.timing.duration*.001,delay:animConfig.animation.timing.delay*.001,ease:animConfig.animation.easing??(0,_interactionsUtils.config)()?.defaultEasing,...repeatOptions};const initialKeyframes={};Object.keys(keyframes).forEach(key=>{initialKeyframes[key]=keyframes[key][0];});element.style.transition='initial';animateFunc(element,initialKeyframes,{duration:0}).then(()=>{const animation=animateFunc(element,keyframes,options);playingInteractionsToStop[id]=animation;animation.then(()=>{requestAnimationFrame(()=>{element.style.transition='';element.style.transform='';element.style.opacity='';});delete playingInteractionsToStop[id];});});}
...
const interactions=Object.values(parsedData?.items||[]);interactions.forEach(interaction=>{const animConfig=(0,_interactionsUtils.extractAnimationConfig)(interaction);if(animConfig){applyAnimation(element,animConfig,animateFunc);}});}
